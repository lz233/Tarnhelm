...
class SettingsFragment(val rootView: View) : PreferenceFragmentCompat() {
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        val workOnEditTextMenu: TwoStatePreference = findPreference("workOnEditTextMenu")!!
        val workOnXposed: TwoStatePreference = findPreference("workOnXposed")!!
        ...
        workOnXposed.setOnPreferenceChangeListener { preference, newValue ->
            Snackbar.make(rootView, "Open LSPosed to modify.", Toast.LENGTH_SHORT).show()
            false
        }
    }
}